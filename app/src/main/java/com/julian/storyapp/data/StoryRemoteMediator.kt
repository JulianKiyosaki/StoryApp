package com.julian.storyapp.data
...
import com.julian.storyapp.database.RemoteKeys
...
class StoryRemoteMediator (
    ...
    override suspend fun load(
        ...
        return try {
            val token = "Bearer ${preference.getUserToken().firstOrNull() ?: ""}"
            if (token.isBlank()) return MediatorResult.Error(Exception("Token is missing"))
